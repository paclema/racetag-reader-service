...
#
# purpose: turn on a digital output pin when a tag read CRC error is detected 
#
...
#         "on"
#
# This routine will turn on a dio output if a tag read CRC error is detected.  The
# dio output pin number can be specified on the command line.  If not
# specified, dio output pin 1 is used.
...
# examples: 
#    signal_read_crc_error.py         # turns on digital output 1 for 1000 milliseconds on tag read CRC error 
#    signal_read_crc_error.py 2       # turns on digital output 2 for 1000 milliseconds on tag read CRC error           
#    signal_read_crc_error.py 1 5000  # turns on digital output 1 for 5000 milliseconds on tag read CRC error
#    signal_read_crc_error.py 1 500   # turns on digital output 1 for 500 milliseconds on tag read CRC error
#    signal_read_crc_error.py 1 800 0 # turns on digital output 1, logic level 0
#                                      for on, for 800 milliseconds on tag CRC error
# 
...
#
# register for tag read bad crc events
#
cmd.sendcommand('reader.events.register(id='+evtid+',name=event.status.tag_read_bad_crc)')
